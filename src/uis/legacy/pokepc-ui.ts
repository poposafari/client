...
// import { PokemonGender, PokemonSkill } from '../object-legacy/pokemon-object';
...
// import { ListUi } from './legacy/list-ui';
...
// import { PlayerObject } from '../object-legacy/player-object';
...
// export class PokePCUi extends Ui {
...
//     this.bg = addBackground(this.scene, TEXTURE.BG_PC).setOrigin(0.5, 0.5);
...
//     this.topInfoWindow = addImage(this.scene, TEXTURE.PC_NAME, 0, -390).setScale(2.8);
//     this.bottomInfoWindow = addImage(this.scene, TEXTURE.PC_DESC, -10, +410).setScale(2.8);
...
//     if (shiny) {
//       this.shiny.setTexture(TEXTURE.ICON_SHINY);
...
//   constructor(scene: InGameScene, pokeboxUi: PokePCUi) {
//     super(scene);
...
//     this.boxArrowLeft = addImage(this.scene, TEXTURE.PC_ARROW, -405, -405).setDisplaySize(100, 100);
//     this.boxArrowRight = addImage(this.scene, TEXTURE.PC_ARROW, +405, -405).setDisplaySize(100, 100).setFlipX(true);
