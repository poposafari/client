...
//     const window = addWindow(this.scene, TEXTURE.WINDOW_0, 0, 0, this.questionWindowWidth / this.scale, this.questionWindowHeight / this.scale, 16, 16, 16, 16).setScale(this.scale);
...
//       this.endMark.anims.play(ANIMATION.PAUSE_B);
//     } else {
//       this.endMarkContainer.setVisible(false);
...
//     return new Promise((resolve) => {
//       let choice = 0;
//       this.questionDummys[0].setTexture(TEXTURE.ARROW_B);
...
//               this.questionDummys[choice].setTexture(TEXTURE.ARROW_B);
//             }
//           }
//         } catch (error) {
