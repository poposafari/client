...
export const battle: TranslationBattle = {
  ...
  messageAppear: '앗! 야생의 {{name, 이/가}} 나타났다!',
  messageIdle: '{{nickname, 은/는}} 무엇을 던질까?',
  messageThrewBall: '{{nickname, 은/는}} 사파리볼을 던졌다!',
  messageThrewFeed: '{{nickname, 은/는}} 먹이를 던졌다!',
  messageThrewMud: '{{nickname, 은/는}} 진흙을 던졌다!',
