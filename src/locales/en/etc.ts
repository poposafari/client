...
export const etc: TranslationEtc = {
  ...
  s000_guide_menu_0: 'Press {{key}} to open the menu.',
  s000_guide_menu_1:
    'In the menu you can access many features\nlike the Pokémon Box, Bag, and PokéRadar.',
  s000_guide_register: 'Press {{key}} to quickly use your registered item.',
