...
//   constructor(scene: InGameScene, gender: PlayerGender, avatar: number, pet: string | null, x: number, y: number, map: Phaser.Tilemaps.Tilemap | null, nickname: string, type: OBJECT) {
