...
export class PokeBoxSlotUi extends Ui {
  ...
  setup(): void {
    ...
    const windowParty = addWindow(this.scene, TEXTURE.WINDOW_12, 0, 20, contentHeight + 30, contentHeight * this.MaxSlot, 16, 16, 16, 16).setScale(1.6);
    ...
    const windowPet = addWindow(this.scene, TEXTURE.WINDOW_12, 0, -390, contentHeight + 30, contentHeight + 30, 16, 16, 16, 16).setScale(1.6);
