...
const POKEMON_TYPE_FRAME: Record<PokemonType, string> = {
  normal: 'types_empty-18',
  fire: 'types_empty-1',
  water: 'types_empty-2',
  electric: 'types_empty-3',
  grass: 'types_empty-4',
  ice: 'types_empty-5',
  fighting: 'types_empty-6',
  poison: 'types_empty-7',
  ground: 'types_empty-8',
  flying: 'types_empty-9',
  psychic: 'types_empty-10',
  bug: 'types_empty-11',
  rock: 'types_empty-12',
  ghost: 'types_empty-13',
  dragon: 'types_empty-14',
  dark: 'types_empty-15',
  steel: 'types_empty-16',
  fairy: 'types_empty-17',
};
